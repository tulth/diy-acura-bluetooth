...
class ToggleElement(object):
    ...
    def fromTimeValStr(self, time, valStr):
        self.time.fromTime(time)
...
def fromTimeValStr_ToggleElement(time, valStr, mbusTimeFormat="microsHex"):
    togElem = ToggleElement(mbusTimeFormat)
    togElem.fromTimeValStr(time, valStr)
    return togElem
